...
#warning("法二")
    ...
    func compileAndLinkShader() {
        ...
        //2. 编译顶点着色器程序、片元着色器程序
        let vertShader = compileShader(shaderName: "CQOpenGLGray.vsh", shaderType: GLenum(GL_VERTEX_SHADER))
        let fragShader = compileShader(shaderName: "CQOpenGLGray.fsh", shaderType: GLenum(GL_FRAGMENT_SHADER))
