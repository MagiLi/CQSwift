...
class CQLoadingAnimateView: UIView {
    ...
    var currentAnimateStatus:CQLoadingStatus = .onlyRoate_0 // 当前动画状态
    ...
    func drawCircle(_ rect: CGRect, _ startAngle:CGFloat, _ endAngle:CGFloat) {
        ...
        let path1 = UIBezierPath.init(arcCenter: center, radius: 15.0, startAngle: startAngle, endAngle: endAngle, clockwise: true)
        path1.lineWidth = 1.7
        path1.lineCapStyle = .round
        UIColor(r: 72.0, g: 112.0, b: 231.0).setStroke()
//        UIColor.colorHex(hex: "#4a7ae0")
//        UIColor.orange.setStroke()
    ...
    deinit {
        print("CQLoadingAnimateView deinit")
    }
